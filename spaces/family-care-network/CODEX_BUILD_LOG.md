...
The next engineering step is targeted Modal validation: one translation test, one ASR test, one Qwen analysis test, then stop Modal services until demo recording.
